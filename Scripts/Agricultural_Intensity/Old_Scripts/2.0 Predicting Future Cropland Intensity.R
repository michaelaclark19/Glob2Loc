...
# Importing functions
source(paste0(getwd(),"/Scripts/Agricultural Intensity/0.0Functions for  Predicting Future Cropland Intensity.R"))
...
i = 'BAU'
project.intensity.function(years)

# And looping to copy file to other directories
for(i in directories[!(directories %in% 'BAU')]) {
  file.copy(from = paste0(getwd(),"/Ag Intensity Outputs/Cropland Intensity Forecasts/BAU/Cropland_Intensity_2010.tif"),
            to = paste0(getwd(),"/Ag Intensity Outputs/Cropland Intensity Forecasts/",i,"/Cropland_Intensity_2010.tif"),
            overwrite = TRUE)
}
...
project.intensity.function <-
  function(y) {
    ...
    # /Users/maclark/Desktop/Multiple Stresses of Biodiversity/Ag Intensity Outputs/Cropland Intensity Forecasts
