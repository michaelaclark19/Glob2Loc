...
# Saving file
write.csv(esh.df3,
          "/Users/maclark/Desktop/Multiple Drivers of Biodiversity/Response to Habitat Intensification/Output Estimates/Estimated Values 20February2020.csv", row.names = FALSE)


esh.df3 <- read.csv("/Users/maclark/Desktop/Multiple Drivers of Biodiversity/Response to Habitat Intensification/Output Estimates/Estimated Values 20February2020.csv", stringsAsFactors = FALSE)
...
tetra_density <- 
  read.csv("/Users/maclark/Desktop/Multiple Drivers of Biodiversity/Multiple_stresses_-_estimating_pop_densities/TetraDENSITY copy2.csv",stringsAsFactors = FALSE) %>%
...
# And writing file
write.csv(out.frame,
          "/Users/maclark/Desktop/Multiple Drivers of Biodiversity/Response to Habitat Intensification/Output Estimates/Estimated Values 23February2020.csv", row.names = FALSE)
