...
species_loop_function <-
  function(ss) {
    ...
    write.csv(out_df_nomigrate,
              paste0(files_write_wd,'/Outputs/Managed_CSV_Files/Abs_Impacts/',tt,'/',ss,'_nopatchmigration_',thresh,'.csv'),
              row.names = FALSE)
    ...
    write.csv(out_df_nomigrate_prop,
              paste0(files_write_wd,'/Outputs/Managed_CSV_Files/Prop_Impacts/',tt,'/',ss,'_nopatchmigration_',thresh,'.csv'),
              row.names = FALSE)
