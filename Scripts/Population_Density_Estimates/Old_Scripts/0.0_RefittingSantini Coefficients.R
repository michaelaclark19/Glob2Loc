...
temp_mean <- raster(paste0(getwd(),"/Global Climate Maps/Current Climate 2010/mean_temperature_2010.tif"))
precip_var <- raster(paste0(getwd(),"/Global Climate Maps/Current Climate 2010/variation_in_precip_2010.tif"))
precip_warmest <- raster(paste0(getwd(),"/Global Climate Maps/Current Climate 2010/precip_warmest_quarter_2010.tif"))
temp_var <- raster(paste0(getwd(),"/Global Climate Maps/Current Climate 2010/variation_in_temperature_2010.tif"))
