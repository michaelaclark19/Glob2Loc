...
temp_mean <- raster(paste0(getwd(),'/CMIP6_Climate_Data/Historic/1995-2014/Managed_Rasters/Mean_temp_Mollweide.tif'))
precip_var <- raster(paste0(getwd(),'/CMIP6_Climate_Data/Historic/1995-2014/Managed_Rasters/Precip_var_Mollweide.tif'))
precip_warmest <- raster(paste0(getwd(),'/CMIP6_Climate_Data/Historic/1995-2014/Managed_Rasters/Precip_warmest_quarter__Mollweide.tif'))
temp_var <- raster(paste0(getwd(),'/CMIP6_Climate_Data/Historic/1995-2014/Managed_Rasters/Temp_var_Mollweide.tif'))
...
write_csv(tetra_data,
          paste0(getwd(),"/Other Data Inputs/Pop Density Inputs/SantiniModellingData.csv"))
...
write_csv(fixed_effects,
          path = paste0(getwd(),"/Population Density Estimates/RefittedSantiniModelCoefficients_fixed_Mammals.csv"))
write_csv(random_effects_weighted[[1]],
          path = paste0(getwd(),"/Population Density Estimates/RefittedSantiniModelCoefficients_random_binomial_Mammals.csv"))
write_csv(random_effects_weighted[[2]],
          path = paste0(getwd(),"/Population Density Estimates/RefittedSantiniModelCoefficients_random_family_Mammals.csv"))
write_csv(order_effects,
          path = paste0(getwd(),"/Population Density Estimates/RefittedSantiniModelCoefficients_random_order_Mammals.csv"))

# I'm also saving the total data to check things
write_csv(tetra_mam1,
          path = paste0(getwd(),"/Population Density Estimates/TetraDatabaseForChecking_Mammals.csv"))
...
# Save the model-averaged coefficients -----
write_csv(fixed_effects,
          path = paste0(getwd(),"/Population Density Estimates/RefittedSantiniModelCoefficients_fixed_Birds.csv"))
write_csv(random_effects_weighted[[1]],
          path = paste0(getwd(),"/Population Density Estimates/RefittedSantiniModelCoefficients_random_binomial_Birds.csv"))
write_csv(random_effects_weighted[[2]],
          path = paste0(getwd(),"/Population Density Estimates/RefittedSantiniModelCoefficients_random_family_Birds.csv"))
write_csv(order_effects,
          path = paste0(getwd(),"/Population Density Estimates/RefittedSantiniModelCoefficients_random_order_Birds.csv"))

# I'm also saving the total data to check things
write_csv(tetra_birds1,
          path = paste0(getwd(),"/Population Density Estimates/TetraDatabaseForChecking_Birds.csv"))
...
# Save the model-averaged coefficients -----
write_csv(fixed_effects,
          path = paste0(getwd(),"/Population Density Estimates/RefittedSantiniModelCoefficients_fixed_Amphibians.csv"))
write_csv(random_effects_weighted[[1]],
          path = paste0(getwd(),"/Population Density Estimates/RefittedSantiniModelCoefficients_random_family_Amphibians.csv"))
# write_csv(random_effects_weighted[[2]],
...
write_csv(tetra_amps1,
          path = paste0(getwd(),"/Population Density Estimates/TetraDatabaseForChecking_Amphibians.csv"))
