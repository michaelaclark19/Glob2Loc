...
if('SantiniModellingData_8April2022.csv' %in% list.files(paste0(getwd(),'/Other Data Inputs/Pop Density Inputs'))) { # if it exists
  # Do all the below
  ...
  #           paste0(getwd(),"/Other Data Inputs/Pop Density Inputs/SantiniModellingData_8April2022.csv"))
  
  write_csv(tetra_data, "/Volumes/Citadel/Oxford/Research Projects/Multiple Drivers of Biodiversity/Pop Density Data Sets/SantiniModellingData_8April2022.csv")
...
tetra_data <- read_csv("/Volumes/Citadel/Oxford/Research Projects/Multiple Drivers of Biodiversity/Pop Density Data Sets/SantiniModellingData_8April2022.csv")
...
for(t in c('aves','mammalia','amphibia')) {
  pop.density.function(t)
}
