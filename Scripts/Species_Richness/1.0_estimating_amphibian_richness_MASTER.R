...
# getting maps
reptile_maps <- list.files(paste0(getwd(),'/ESH_Tifs_12Oct/Amphibians'), full.names = TRUE)
...
richness_fun <- 
  function(z) {
    ...
    write.csv(template_df,
              paste0('/data/ouce-glob2loc/pubh0329/Multiple_Stresses_of_Biodiversity/Other Data Inputs/Species Richness Rasters/amphibian_richness_df_',z,'.csv'),
    row.names = FALSE)
