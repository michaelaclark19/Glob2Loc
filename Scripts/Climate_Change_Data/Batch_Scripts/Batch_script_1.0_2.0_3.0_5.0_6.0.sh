...
Rscript /data/pubh-glob2loc/pubh0329/Multiple_Stresses_of_Biodiversity/Scripts/Climate_Change_Data/1.0_Calculating_Precip_Warmest_Quarter.R
...
Rscript /data/pubh-glob2loc/pubh0329/Multiple_Stresses_of_Biodiversity/Scripts/Climate_Change_Data/6.0_Total_precipitation.R
